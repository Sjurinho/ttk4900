...
def main():
    #filepath = "../data/"
    filepath = "../data/recorded_runs/python_plots/Saved/newestSensorComparisons/lidar/"
    ...
    estimates, gts = bag2numpy(f'{filepath}simpleTunnel_straightPath_lidar.bag')
    ...
    SmoothingEstVsGt = plotTrajectory2D(estimates, estimatesAfterSmoothing, gts, skipPlt=2, ylim=[-50, 50], xlim=[-10, 250], title="Estimated Position Vs True Position", lastGT=est_to_gt_before_smoothing[-1])
