...
class Graph
{
    ...
    private:
        ...
        bool smoothingEnabledFlag=true, imuEnabledFlag=false, gnssEnabledFlag=false, loopClosureEnabledFlag=false;
        double voxelRes = 0.3;
        ...
        bool newLaserOdometry=false, newMap=false, newGroundPlane=false, newImu=false, updateImu=false, newGnss=false, reinitialize=false, onlyImu=false;
